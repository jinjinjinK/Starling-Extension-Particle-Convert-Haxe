...
class ParticleSystem extends DisplayObject implements IAnimatable
{
            ...
            blendFactorSource : String = null, blendFactorDest : String = null)
    {
        ...
        if (blendFactorDest != null) mBlendFactorDestination = blendFactorDest;
		else mBlendFactorDestination = Context3DBlendFactor.ONE_MINUS_SOURCE_ALPHA;
    ...
    private function raiseCapacity(byAmount : Int) : Void
    {
        ...
        {
            setArrayLength(mParticles, newCapacity);
            setArrayLength(mIndices, newCapacity * 6);
        }
    ...
    public function setArrayLength<T>(a:Vector<Null<T>>, length:Int)
	{
    ...
    public function advanceTime(passedTime : Float) : Void
    {
        ...
        while (particleIndex < mNumParticles)
        {
            ...
            else
            {
                ...
                {
                    var nextParticle : Particle = try cast(mParticles[Std.int(mNumParticles - 1)], Particle) catch(e:Dynamic) null;
        ...
        for (i in 0...mNumParticles)
        {
            ...
            if (rotation != 0 && !Math.isNaN(rotation))
            {
