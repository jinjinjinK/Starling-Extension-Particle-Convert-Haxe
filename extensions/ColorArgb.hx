...
class ColorArgb
{
    ...
    public function toRgb() : Int
    {
        ...
        return Std.int(Std.int(r * 255) << 16 | Std.int(g * 255) << 8 | Std.int(b * 255));
    }
    
    public function toArgb() : Int
    {
        var a : Float = alpha;if (a < 0.0)
        {
            a = 0.0;
        }
        else
